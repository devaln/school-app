    ...
    <div class="container mt-4" align="center">
        ...
        <table class="table" border="5px">
            ...
            <tbody align="center">
                ...
                <td><a class="btn btn-secondary" href="teacher_update.php?id=<?php echo $row['id']; ?>">Edit</a><b> || </b><a class="btn btn-danger" href="teacher_delete.php?id=<?php echo $row['id']; ?>">Delete</a></button></td>
                </tr>
                <?php $count++; } ?>
            </tbody>
        </table><br>
