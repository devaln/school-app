        ...
        <table class="table" border="5px">
            <thead align="center">
                <tr>
                    ...
                    <th>Phone Number</th>
                    <th>loggedin Type</th>
                    <th><a class="btn btn-primary" href="student_create.php">ADD</a></th>
                </tr>
            </thead>
            <?php 
            $count=1;
            ...
            <tbody align="center">
                ...
                <td><a class="btn btn-secondary" href="student_update.php?id=<?php echo $row['id']; ?>">Edit</a><b> || </b><a class="btn btn-danger" href="student_delete.php?id=<?php echo $row['id']; ?>">Delete</a></button></td>
                </tr>
                <?php $count++; } ?>
            </tbody>
        </table><br>
